...
import { GeneralMaterialListService, GeneralMaterial } from './general-material-list-service';

@Component({
  selector: 'app-general-material-list',
  templateUrl: './general-material-list.component.html',
  styleUrls: ['./general-material-list.component.css'],
  providers: [GeneralMaterialListService]
})
export class GeneralMaterialListComponent implements OnInit {

  generalMaterialsDataSource: Array<GeneralMaterial>;

  constructor(public generalMaterialService: GeneralMaterialListService) {
    this.refreshData();
